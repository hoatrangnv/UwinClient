...
public class WebServiceController : MonoBehaviour
{
    ...
    public string GetUrl(WebServiceCode.Code code)
    {
        switch (code)
        {
            ...
            case WebServiceCode.Code.GetTokenAuthen:
                return urlApiPortal + "/Account/GetTokenAuthen";
            ...
            case WebServiceCode.Code.GetNotification:
                return urlEvent + "/Gate/GetNotification";
            case WebServiceCode.Code.GetBigJackpotInfoFarm:
