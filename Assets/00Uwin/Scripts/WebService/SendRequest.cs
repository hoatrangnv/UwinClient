...
public class SendRequest
{
    ...
    public static void SendGetTokenAuthen()
    {
        WebServiceController.Instance.SendRequest(WebServiceCode.Code.GetTokenAuthen, null, HTTPMethods.Get);
    }
    ...
    public static void SendUpdatePhone(string phone, string otp)
    {
    ...
    public static void SendRequestTransfer(string acount, string amount, string reason, string captcha, string token)
    {
    ...
    public static void RequestSendMoney(string money, string captcha, string tonken)
    {
    ...
    public static void RequestReceiveMoney(string money, string captcha, string tonken)
    {
        SFishingMoney data = new SFishingMoney
        {
            amount = money,
        ...
        WebServiceController.Instance.SendRequest(WebServiceCode.Code.ReceiveFishingMoney, data, HTTPMethods.Post);
    }
    ...
    public static void SendEventGetGetNotifycation()
    {
        WebServiceController.Instance.SendRequest(WebServiceCode.Code.GetNotification, null, HTTPMethods.Get);
    }
